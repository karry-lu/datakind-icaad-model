...
def load_keyword_dict(): 
	...
	'vaccin',
	'medical facilit',
	'sexual and reproductive (right|health service|product)',
	'safe drinking water',
	'wastewater',
	...
	keyword_dict['SDG_5'] = [
	'gender (equality|inequality|equity|inequality|strategy|discrimination|disparit|gap)',
	'mothers',
	'women',
	'female',
	'pregnant',
	...
	'(right to|disparities in|standards of) employment',
	'promotion of work',
	'employment of youth',
	...
	'gender equality',
	'disabilit',
	'indigenous (person|people|population|communit)',
	'discrimination',
	'roma',
	'migration',
	'icrmw',
	...
	'climate change',
	'air quality',
	'rural (area|communit|infrastructure)',
	'remote (area|communit)',
	'urban-rural inequalit'
	]
	...
	'(?=cooperation)(?=regional|international|united nations bodies)',
