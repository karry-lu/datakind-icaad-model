...
def load_keyword_dict():
	...
	keyword_dict['SDG_2'] = [
	'food (((in)*security)|(provision)|(supply)|(distribut)|(self(.*)sufficiency)|(assistance)|(produc))',
	...
	keyword_dict['SDG_3'] = [
	'((maternal)|(child)|(infant))( mortality)',
	'low life expectancy',
	'high mortality rate',
	...
	'nursing',
	'girl',
	'maternal ((health)|(mortality)|(morbidity))',
	...
	'climate change',
	'air quality',
	'rural ((area)|(communit)|(infrastructure)|(growth)|(health)|(population))',
	...
	'(?=prison)(?=condition)',
	'right to ((participat)|(be consulted))',
